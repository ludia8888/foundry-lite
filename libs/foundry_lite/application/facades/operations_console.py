...
from foundry_lite.application.admin_overview import (
    ...
    AdminTaskPlan,
    build_admin_readiness_overview,
...
class OperationsConsole:
    ...
    def admin_readiness_overview(self, *, ctx: RequestContext | None = None) -> AdminReadinessOverview:
        resolved_ctx = ctx or RequestContext()
        self._runtime._require_or_audit(resolved_ctx, "operations:read:detail", "admin", "overview")
        return build_admin_readiness_overview()

    def admin_task_plan(self, *, ctx: RequestContext | None = None) -> AdminTaskPlan:
        resolved_ctx = ctx or RequestContext()
