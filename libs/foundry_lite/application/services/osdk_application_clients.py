...
class OsdkApplicationClientMixin:
    ...
    def _create_client_json(
        ...
        self._audit(conn, ctx, "osdk.application.client_created", updated)
    ...
    def _update_client_json(
        ...
        self._audit(conn, ctx, "osdk.application.client_updated", updated, row, updated)
        return cast(RuntimeJsonObject, updated)
    ...
    def _deactivate_client_json(
        ...
        self._audit(conn, ctx, "osdk.application.client_deactivated", updated, row, updated)
        return cast(RuntimeJsonObject, updated)
