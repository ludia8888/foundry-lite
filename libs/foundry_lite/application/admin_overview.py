"""Read models that describe which admin operations are browser-safe today."""
...
class AdminOperationCapability(TypedDict):
    """One admin capability with its current execution boundary."""
...
class AdminReadinessSummary(TypedDict):
    """Counts of admin capabilities by readiness bucket."""
...
class AdminReadinessOverview(TypedDict):
    """Screen-ready inventory of current and future admin capabilities."""
...
class AdminOperationTask(TypedDict):
    """One operator task derived from an admin capability row."""
...
class AdminTaskPlanSummary(TypedDict):
    """Counts of admin tasks by who can safely perform them."""
...
class AdminTaskPlan(TypedDict):
    """Screen-ready task plan for operations administration."""
