...
def _ontology_mcp_post_response(
    ...
    try:
        ...
        log_mcp_internal_failure(_LOGGER, request, plane="ontology", rpc_method=payload.method, exc=exc)
    ...
    try:
        ...
        try:
            events = runtime.foundry.ontology_mcp.session_events(
                ...
                application_id,
                session_id,
                after_sequence=mcp_last_event_sequence(request, session_id, "Ontology"),
            )
        except Exception:
