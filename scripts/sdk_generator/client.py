...
def _client_type_lines(surface: SdkClientSurface) -> list[str]:
    lines = [
        ...
        "  auth: {",
        "    browser: {",
        "      configuration(): Promise<BrowserAuthConfiguration>;",
        "      session(): Promise<FoundryLiteRequestContext>;",
        "    };",
        "    osdkOAuth: {",
...
def _client_runtime_lines(surface: SdkClientSurface) -> list[str]:
    ...
    lines += [
        ...
        "    auth: {",
        "      browser: {",
        "        configuration: () => request<BrowserAuthConfiguration>(`/api/auth/browser/config`),",
        "        session: () => request<FoundryLiteRequestContext>(`/api/auth/browser/session`),",
        "      },",
        "      osdkOAuth: {",
