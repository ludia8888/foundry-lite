...
PYTHON_CHECKS: tuple[tuple[str, list[str]], ...] = (
    ...
    ("exception-string-redaction", ["scripts/quality/check_exception_string_redaction.py"]),
    ("silent-broad-exceptions", ["scripts/quality/check_silent_broad_exceptions.py"]),
    ("foundry-runtime-lifecycle", ["scripts/quality/check_foundry_runtime_lifecycle.py"]),
