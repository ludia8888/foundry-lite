...
| `docs/aip-lite-canonical-spec.md`                        | `reference`        | AIP-lite design spec and Palantir cross-check  | Model Gateway/registry/egress 등 AIP-lite 섹션의 설계 원본과 documented-Palantir vs our-extension 대조를 담는다.                                           |
