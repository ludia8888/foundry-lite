...
|---|---|
| Elasticsearch live cluster deployment/managed operations, Iceberg, Spark, Kubernetes production adapters | Sprint 42 adds the Elasticsearch-compatible adapter and projection proof; live cluster deployment and Sprint 43-45 production-scale adapters remain future work. |
