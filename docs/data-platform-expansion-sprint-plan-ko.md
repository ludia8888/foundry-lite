...
- [~] frontend API compatibility test: `quality:frontend-backend-surface`,
  ...
  proofClass -> proof test -> operator evidence matrix, 177개 browser SDK route surface
...
`quality:sdk-request-contract`는 실제 browser SDK를 import해 177개 frontend route surface의
