...
- [~] frontend API compatibility test: `quality:frontend-backend-surface`,
  ...
  proofClass -> proof test -> operator evidence matrix, 322개 browser SDK route surface
...
`quality:sdk-request-contract`는 실제 browser SDK를 import해 322개 frontend route surface의
