...
- [ ] CI는 domain/application이 금지된 concrete infra SDK를 직접 import하면 실패한다.
  - [x] 현재 CI는 domain concrete infra import 0개, application concrete infra import baseline 15개 초과, scale SDK 직접 import, mixin method 충돌을 잡는다.
  ...
  - [ ] application concrete infra import baseline을 15에서 0으로 낮추는 repository/adapter 추출은 남아 있다.
